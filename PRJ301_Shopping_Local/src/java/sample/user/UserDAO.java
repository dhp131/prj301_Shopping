...
public class UserDAO {
    ...
    private static String LOGIN = "SELECT userId, fullName, password, address, email, phone, roleID \n"
            + "FROM customers \n"
            + "WHERE fullName=? AND password=? OR email=? AND password=?";
    private static String SEARCH_CUSTOMER = "SELECT userId, fullName, password, address, email, phone, roleID \n"
            + "FROM customers\n"
            + "WHERE fullName like ?";
    ...
    private static String INSERT_CUSTOMER = "INSERT INTO customers(fullName, password, address, email, phone, roleID) VALUES(?,?,?,?,?,'US')";
